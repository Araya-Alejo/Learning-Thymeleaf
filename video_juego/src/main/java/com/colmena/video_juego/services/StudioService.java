...
public class StudioService implements BaseService< Studio > {
    ...
    @Override
    @Transactional
    public Studio saveOne( Studio entity ) throws Exception {
        try {
    ...
    @Override
    @Transactional
    public Studio updateOne( Studio entity, long id ) throws Exception {
        try {
            return this.studioRepository.save( entity );
        } catch ( Exception e ) {
            throw new Exception( e.getMessage( ) );
    ...
    public boolean deleteById( long id ) throws Exception {
        try {
            Optional< Studio > optionalStudio = this.studioRepository.findById( id );
